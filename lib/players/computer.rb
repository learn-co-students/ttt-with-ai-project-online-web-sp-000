...
module Players
    class Computer < Player
        ...
        # def move(board)
        #     # on turn 1, go for middle, 5, if it is not occupied
        #     # Otherwise, go for corners, 1, 3, 7, or 9 if not occupied
        #     # Otherwise, go for last choices, 2, 4, 6, or 8 if not occupied
